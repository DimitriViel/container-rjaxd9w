...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rjaxd9w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rjaxd9w.containers.anotherwebservice.com/
...
```
git clone git@github.com:DimitriViel/container-rjaxd9w.git
cd container-rjaxd9w
```
...
```
docker attach container-rjaxd9w
```
